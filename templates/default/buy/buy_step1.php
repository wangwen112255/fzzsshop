...
function calcOrder() {
    ...
    $('em[nc_type="eachStoreTotal"]').each(function(){
        ...
        if ($('#eachStoreGoodsTotalService_'+store_id).length > 0) {
            eachTotal += parseFloat($('#eachStoreGoodsTotalService_'+store_id).html());
        }
        if ($('#eachStoreGoodsTotalTrue_'+store_id).length > 0) {
            eachTotal += parseFloat($('#eachStoreGoodsTotalTrue_'+store_id).html());
        }
