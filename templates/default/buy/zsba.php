...
<div class="ncc-main">
  <div class="ncc-title">
    ...
    <h5>查看债事备案记录可以通过<a href="index.php?act=predeposit&op=index" target="_blank">我的债事备案列表 </a>进行查看。</h5>
  </div>
  <form action="index.php?act=payment&op=zs_order" method="POST" id="buy_form">
    <input type="hidden" name="zs_sn" value="<?php echo $output['zs_info']['pay_id'];?>">
    <input type="hidden" id="payment_code" name="payment_code" value="">
    <div class="ncc-receipt-info">
    <div>申请单号 : <?php echo $output['zs_info']['pay_id'];?></div>
      <div class="ncc-receipt-info-title">
        <h3>您已申请债事备案审核，请立即在线支付！
          备案金额：<strong>￥<?php echo $output['zs_info']['audit_money'];?></strong> </h3>
      </div>
    </div>
    <div class="ncc-receipt-info">
