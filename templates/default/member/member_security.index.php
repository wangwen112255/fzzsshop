...
<div class="wrap">
  ...
  <div class="ncm-security-container">
    ...
    <dl id="paypwd" class="<?php echo $output['member_info']['member_paypwd'] != ''  ? 'yes' : 'no';?>">
      <dt><span class="icon"><i></i></span><span class="item">
        <h4>会员卡绑定</h4>
        <h6><?php echo $output['member_info']['member_card'] != '' ? '已设置' : '未设置';?></h6>
        </span></dt>
      <dd><span class="explain">绑定会员卡。</span><span class="handle"><a href="index.php?act=member_security&op=auth&type=modify_membercard" class="ncm-btn ncm-btn-acidblue bd">绑定会员卡</a><a href="index.php?act=member_security&op=auth&type=modify_membercard" class="ncm-btn ncm-btn-orange jc">修改会员卡</a></span></dd>
    </dl>
  </div>
</div>
