...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <form method="post" id="rechargecard_form" action="index.php">
      ...
      <dl>
        <dt><i class="required">*</i>债权金兑换密码<?php echo $lang['nc_colon']; ?></dt>
        <dd>
...
$('#rechargecard_form').validate({
    ...
    messages : {
        rc_sn : {
            required :'<i class="icon-exclamation-sign"></i>请输入平台债权金号',
            maxlength :'<i class="icon-exclamation-sign"></i>平台债权金号长度小于50'
        }
    }
});
});
