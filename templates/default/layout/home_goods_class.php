        ...
        <ul class="menu">
          ...
          <li cat_id="<?php echo $val['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>8){?>style="display:none;"<?php }?>>
            ...
            <div class="sub-class" cat_menu_id="<?php echo $val['gc_id'];?>">
              ...
              <div style="width: 536px;padding: 20px;padding-bottom:10px;padding-top:10px; ">
                <dt style="border-bottom:1px solid #e5e5e5; margin-bottom:3px;font-size: 12px;color:#333;">
                  <h3 style="color:#333;"><a  class="navtitle" href="<?php echo urlShop('search','index',array('cate_id'=> $v['gc_id']));?>"><?php echo $v['gc_name'];?></a></h3>
                </dt>
