      ...
      <div class="ncs-meta">
        ...
        <dl>
          ...
          <dd class="price">
            ...
            <?php } else {?>
            <strong><?php echo $lang['currency'] ?><?php echo $output['goods']['goods_price'] + $output['goods']['goods_price_zq'];?></strong>
            <?php }?>
          </dd>
        </dl>
        ...
        <dl>
          <dt>债权金：</dt>
          <dd class="price">
            <strong><?php echo $lang['currency'].$output['goods']['goods_price_zq'];?></strong>
          </dd>
        </dl>
		<?php }?>
      ...
      <div class="ncs-plus">
        ...
        <dl class="ncs-freight">
          ...
          <dd id="transport_price">
            ...
            <?php } else { ?>
            <?php if ($output['goods']['goods_freight'] == 0 && $output['goods']['transport_id'] == '0'){?>
            <span id="nc_kd"><?php echo $lang['goods_index_trans_for_seller'];?></span>
            <?php }elseif($output['goods']['transport_id'] == '-1'){?>
            <span id="nc_kd">买家承担运费，货到自提</span>
            <?php }else{?>
            <!-- 如果买家承担运费 -->
