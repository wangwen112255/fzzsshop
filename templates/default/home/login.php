...
<div class="logbg">
<div class="nc-login-layout" style="width: 100%;">
  ...
  <div class="nc-login">
    ...
    <div class="nc-login-content" id="demo-form-site">
      <form id="login_form" method="post" action="index.php?act=login&op=login"  class="bg">
        ...
        <dl>
          <dt><span class="iconfont icon-yonghuming1"></span>
          <!-- <?php echo $lang['login_index_username'];?> -->
          </dt>
          <dd style="min-height:54px;">
            <input type="text" class="text" placeholder="请输入用户名/手机号" autocomplete="off"  name="user_name" id="user_name" autofocus >
            <label></label>
          </dd>
        </dl>
        <dl>
          ...
          <dd style="min-height:54px;">
            <input type="password" class="text" placeholder="请输入密码" name="password" autocomplete="off"  id="password">
            <label></label>
          </dd>
        </dl>
        ...
        <dl>
          ...
          <dd style="min-height:54px;position: relative;">
            <input type="text" name="captcha" autocomplete="off" placeholder="请输入验证码" class="text w50 fl" id="captcha" maxlength="4" size="10" />
            <a href="javascript:void(0)" class="ml5" onclick="javascript:document.getElementById('codeimage').src='<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();">
             <img  style="width: 80px;left:125px;position:absolute;margin-left: -10px;" src="<?php echo SHOP_SITE_URL?>/index.php?act=seccode&op=makecode&nchash=<?php echo getNchash();?>" name="codeimage" border="0" id="codeimage" class="fl ml5">
        ...
        <dl >
          ...
          <dd style="width: 100%;">
            <input style="width: 280px" type="submit" class="submit" value="<?php echo $lang['login_index_login'];?>">
            <a class="forget" href="index.php?act=login&op=forget_password"><?php echo $lang['login_index_forget_password'];?></a>
            <input type="hidden" value="<?php echo $_GET['ref_url']?>" name="ref_url">
            <a class="forget" href="index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']);?>">
              立即注册
            </a>
            <input type="hidden" value="<?php echo $_GET['ref_url']?>" name="ref_url">
          </dd>
