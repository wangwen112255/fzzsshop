...
<div class="item-publish">
  <form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlShop('store_goods_online', 'edit_save_goods');} else { echo urlShop('store_goods_add', 'save_goods');}?>">
    ...
    <div class="ncsc-form-goods">
      ...
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i>应付款：</dt>
        <dd nc_type="no_spec">
          <input name="g_price" value="<?php echo $output['goods']['goods_price']; ?>" type="text"  class="text w60" />
      ...
      <dl>
        <dt nc_type="no_spec"><i class="required">*</i>债权金</dt>
        <dd nc_type="no_spec">
          <input name="g_price_zq" value="<?php echo $output['goods']['goods_price_zq']; ?>" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
        </dd>
      </dl>

      <dl style="display:none">
        <dt nc_type="no_spec"><i class="required">*</i>服务费</dt>
        <dd nc_type="no_spec">
          <input name="g_price_service" value="0" type="text"  class="text w60" /><em class="add-on"><i class="icon-renminbi"></i></em> <span></span>
        </dd>
      </dl>
      ...
      <dl nctype="virtual_null" <?php if ($output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
        ...
        <dd>
          <ul class="ncsc-form-radio-list">
            <li>
              <input id="freight_0" nctype="freight" name="freight" class="radio" type="radio" <?php if ($output['goods']['transport_id'] == 0) {?>checked="checked"<?php }?> value="0">
            ...
            <li style="display:none">
              ...
              <div nctype="div_freight" <?php if ($output['goods']['transport_id'] <= 0) {?>style="display: none;"<?php }?>>
            ...
            <li>
            <input id="freight_2" nctype="freight" name="freight" class="radio" type="radio" <?php if ($output['goods']['transport_id'] == '-1') {?>checked="checked"<?php }?> value="-1">
              <label for="freight_2">买家承担运费,货到自提</label>
            </li>
          </ul>
